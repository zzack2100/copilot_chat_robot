...
const DIRECT_PROMPT_BACKOFF_DELAYS_MS = [1_000, 2_000, 4_000] as const;
...
const tryGeminiModelOnce = async (modelName: string, prompt: string, systemInstruction: string): Promise<string> => {
    if (!genAI) {
